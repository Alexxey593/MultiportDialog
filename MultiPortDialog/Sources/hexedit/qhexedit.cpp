...
void QHexEdit::append(const QByteArray &ba)
{
    qHexEdit_p->append(ba);
}
...
void QHexEdit::setSelectByOneByte(bool mode)
{
    qHexEdit_p->setSelectByOneByte(mode);
}
...
void QHexEdit::addColorizedArea(int begin, int end, QColor color)
{
    qHexEdit_p->addColorizedArea(begin, end, color);
}

void QHexEdit::addColorizedArea(QByteArray data, QColor color)
{
    qHexEdit_p->addColorizedArea(data, color);
}

void QHexEdit::resetColorizedAreas()
{
    qHexEdit_p->resetColorizedAreas();
}
...
void QHexEdit::setCodecName(QByteArray name)
{
    qHexEdit_p->setCodecName(name);
}
